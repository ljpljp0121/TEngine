...
### UnityCodeRule.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [UnityCodeRule.Sample.csproj](../UnityCodeRule.Sample/UnityCodeRule.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 
