...
namespace PFPackage
{
    public class PackageLoader
    {
        ...
        public static async Task<bool> DownloadPackage(PackageInfo package, string targetVersion, Action<float> onProgress = null)
        {
            ...
            var request = await GetRequest(tarballUrl, onProgress, 0);
        ...
        /// 通用HTTP GET请求
        /// </summary>
        private static async Task<UnityWebRequest> GetRequest(string url, Action<float> onProgress = null, int timeout = 10)
        {
