...
namespace PFGraph
{
    ...
    {
        private readonly Dictionary<string, IBindableProperty> m_BindableProperties =
            new Dictionary<string, IBindableProperty>();
        public event Action<object, string> PropertyChanged;

        public IReadOnlyDictionary<string, IBindableProperty> Properties => m_BindableProperties;

        public int Count => m_BindableProperties.Count;
