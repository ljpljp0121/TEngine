...
namespace PFGraph
{
    public partial class BindableCollection<T, TE> : BridgedCollection<T, TE> where T : IList<TE>, new()
    {
        ...
        {
            if (this.monitor.Busy && this.CollectionChanged != null &&
    ...
    public partial class BindableCollection<T, TE> : IBindableProperty, IBindableProperty<T>
    {
        ...
        public void RegisterValueChangedEvent(Action<T, T> onValueChanged) =>
            this.bindableProperty.RegisterValueChangedEvent(onValueChanged);

        public void UnregisterValueChangedEvent(Action<T, T> onValueChanged) =>
            this.bindableProperty.UnregisterValueChangedEvent(onValueChanged);
    }
}