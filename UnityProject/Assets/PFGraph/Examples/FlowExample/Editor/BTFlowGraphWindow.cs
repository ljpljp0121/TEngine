...
public class BTGraphWindow : BaseGraphWindow
{
    ...
    private void Duplicate()
    {
        ...
        nodes = Sirenix.Serialization.SerializationUtility.DeserializeValue<Dictionary<long, BaseNode>>(nodesStr,
            DataFormat.Binary);
        connections =
            Sirenix.Serialization.SerializationUtility.DeserializeValue<List<BaseConnection>>(connectionsStr,
                DataFormat.Binary);
