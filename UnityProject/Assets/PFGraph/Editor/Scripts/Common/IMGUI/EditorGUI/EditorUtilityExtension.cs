...
namespace PFGraph
{
    ...
    {
        public static MonoScript FindScriptFromType(Type type, Func<MonoScript, bool> pattern = null,
            bool compareTypeName = true)
        {
        ...
        public static IEnumerable<MonoScript> FindAllScriptFromType(Type type, Func<MonoScript, bool> pattern = null,
            bool compareTypeName = true)
        {
            string findStr = "t:script " + (compareTypeName ? type.Name : "");
            var scriptGUIDs = AssetDatabase.FindAssets(findStr);
