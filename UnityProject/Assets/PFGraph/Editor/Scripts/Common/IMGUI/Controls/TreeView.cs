...
namespace PFGraph
{
    ...
    public abstract class TreeView : UnityTreeView
    {
        ...
        public TreeView(TreeViewState state, MultiColumnHeader multiColumnHeader, TreeViewItemPool itemPool) : base(
        ...
        protected sealed override bool DoesItemMatchSearch(UnityTreeViewItem item, string search) =>
            DoesItemMatchSearch(item as TreeViewItem, search);
        ...
        public TreeViewItem GetOrAddMenuItem(string path, Texture2D icon = null, char separator = '/',
            bool split = true)
        {
            return GetOrAddMenuItemTo(Root, path, icon, separator, split);
        }

        public TreeViewItem AddMenuItemTo(TreeViewItem parent, string path, Texture2D icon = null, char separator = '/',
            bool split = true)
        {
        ...
        public TreeViewItem GetOrAddMenuItemTo(TreeViewItem parent, string path, Texture2D icon = null,
        ...
        public TreeViewItem InsertMenuItem(string path, int index, Texture2D icon, char separator = '/',
            bool split = true)
        {
            return InsertMenuItemTo(Root, path, index, icon, separator, split);
        }

        public TreeViewItem GetOrInsertMenuItem(string path, int index, Texture2D icon = null, char separator = '/',
            bool split = true)
        {
            return GetOrInsertMenuItemTo(root, path, index, icon, separator, split);
        }

        public TreeViewItem InsertMenuItemTo(TreeViewItem parent, string path, int index, Texture2D icon = null,
            char separator = '/', bool split = true)
        {
            if (string.IsNullOrEmpty(path))
                throw new ArgumentNullException("path");
        ...
        public TreeViewItem GetOrInsertMenuItemTo(TreeViewItem parent, string path, int index, Texture2D icon = null,
            char separator = '/', bool split = true)
        {
            if (string.IsNullOrEmpty(path))
                throw new ArgumentNullException("path");
    ...
    public class SimpleTreeView : TreeView
    {
        ...
        public SimpleTreeView(TreeViewState state, MultiColumnHeader multiColumnHeader) :
            base(state, multiColumnHeader) { }

        public SimpleTreeView(TreeViewState state, MultiColumnHeader multiColumnHeader, TreeViewItemPool itemPool) :
            base(state, multiColumnHeader, itemPool) { }
        ...
        protected override bool DoesItemMatchSearch(TreeViewItem item, string search)
        {
            return base.DoesItemMatchSearch(item, search) ||
                   (doesItemMatchSearch != null && doesItemMatchSearch.Invoke(item, search));
        }
