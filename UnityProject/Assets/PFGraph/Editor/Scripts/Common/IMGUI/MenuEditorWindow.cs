...
namespace PFGraph
{
    public abstract class MenuEditorWindow : EditorWindow
    {
        ...
        protected virtual void OnGUI()
        {
            if (showMenu)
            {
                var r = GUILayoutUtility.GetRect(GUIContent.none, GUIStyle.none, GUILayout.ExpandHeight(true),
        ...
        protected virtual void OnLeftGUI(Rect rect)
        {
            if (MenuTreeView != null)
            {
                ...
                if (MenuTreeViewSearchField.HasFocus() && (Event.current.keyCode == KeyCode.KeypadEnter ||
