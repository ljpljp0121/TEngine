...
namespace PFGraph
{
    ...
    {
        public PropertyAttribute Attribute { get; private set; }
        public SerializedPropertyS Property { get; private set; }
        ...
        public static PropertyDrawer CreateEditor(SerializedPropertyS target, UnityEngine.PropertyAttribute attribute,
            Type editorType)
        {
            PropertyDrawer drawer = Activator.CreateInstance(editorType, true) as PropertyDrawer;
            if (drawer != null)
