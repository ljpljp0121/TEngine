...
namespace PFGraph
{
    ...
    {
        private static CustomStyleProperty<Color> s_CenterLineColorProperty =
            new CustomStyleProperty<Color>("--center-line-color");
        ...
        public BetterGridBackground() : base()
        {
            this.RegisterCallback<CustomStyleResolvedEvent>(
                new EventCallback<CustomStyleResolvedEvent>(this.OnCustomStyleResolved1));
        }
        ...
        protected override void ImmediateRepaint()
        {
            ...
            this.m_Container = this.parent is UnityEditor.Experimental.GraphView.GraphView parent
                ? parent.contentViewContainer
