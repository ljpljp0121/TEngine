...
namespace PFGraph
{
    public abstract partial class BaseNodeView : NodeView, IGraphElementView<BaseNodeProcessor>
    {
        ...
        public bool Selectable
        {
            ...
            set => capabilities =
                value ? (capabilities | Capabilities.Selectable) : (capabilities & ~Capabilities.Selectable);
        }
        ...
        public bool Deletable
        {
            ...
            set => capabilities =
                value ? (capabilities | Capabilities.Deletable) : (capabilities & ~Capabilities.Deletable);
        }
        ...
        public bool Movable
        {
            ...
            set => capabilities =
                value ? (capabilities | Capabilities.Movable) : (capabilities & ~Capabilities.Movable);
        }
        ...
        private void OnIndexChanged(int oldIndex, int newIndex)
        {
            if (this.Owner.Context.graphWindow.UnityGraphAssetSO != null)
            {
                ...
                this.BindingProperty =
                    this.Owner.Context.graphWindow.UnityGraphAssetSO.FindProperty($"data.nodes.Array.data[{newIndex}]");
            }
        }
