...
namespace PFGraph
{
    public sealed partial class GroupView : UnityEditor.Experimental.GraphView.Group, IGraphElementView<GroupProcessor>
    {
        ...
        public GroupView()
        {
            ...
            this.TitleField.RegisterCallback<FocusInEvent>(evt =>
            {
                Input.imeCompositionMode = IMECompositionMode.On;
            });
            this.TitleField.RegisterCallback<FocusOutEvent>(evt =>
            {
        ...
        private void OnViewModelChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            {
                case nameof(PFGraph.Group.position):
                {
                    base.SetPosition(new Rect(group.Position.ToVector2(), GetPosition().size));
                    break;
                }
                case nameof(PFGraph.Group.groupName):
                {
                ...
                case nameof(PFGraph.Group.backgroundColor):
                {
